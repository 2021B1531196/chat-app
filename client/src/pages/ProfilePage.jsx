...
const ProfilePage = () => {
    ...
    const[bio, setBio] = useState('I am a cat lover and I love to play with my cat. I am a software engineer and I love to code. I am a foodie and I love to eat. I am a traveler and I love to travel. I am a photographer and I love to take photos. I am a gamer and I love to play games. I am a music lover and I love to listen to music. I am a movie lover and I love to watch movies. I am a book lover and I love to read books. I am a sports lover and I love to play sports.');
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
                ...
                <input onChange={(e)=>setName(e.target.value)} value={name}
                 ...
                 <textarea onChange={(e)=>setBio(e.target.value)} value={bio}
                  placeholder='Bio' required className='p-2
